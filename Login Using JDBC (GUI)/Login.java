...
public class login extends javax.swing.JFrame {
    ...
    String s="SELECT * from login where UserId='"+id+"'and Password='"+pwd+"'";
    ...
    if(r.next()){
      ...
      JOptionPane.showMessageDialog(new JFrame(),"Incorrect ID or Password", "Message",
   ...
   com.close();
    ...
    private void resetbtn(java.awt.event.ActionEvent evt) {                          
